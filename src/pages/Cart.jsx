...
const Cart = () => {
  ...
  const [address, setAddress] = useState("chennai , 600085");
            ...
            <div className="md:w-2/3">
                ...
                {cart.products.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex space-x-12 items-center">
                      ...
                      value={console.log(product.id, "idssss")}>
                        <FaTrashAlt />
                      </button>
                    </div>
                  </div>
              ...
              <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md border">
                ...
                <div className="mb-4 border-b pb-2">
                  <p>Shipping:</p>
                  <p className="m1-2">Shipping to:</p>
                  <span className="text-xs font-bold">
                    {address} {""}
                  </span>
                  <button
                    className="text-blue-500 hover:underline mt-1 m1-2"
